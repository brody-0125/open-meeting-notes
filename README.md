...
**엄격한 외부 통신 금지 배포 요건은 아직 충족하지 않았습니다.** 앱의 로컬 추론·Chromium 요청 제한과 OS 전체 송신 차단은 별개이며, OS 차단·코드 서명·대상 Windows 10/macOS 장비 검증이 남아 있습니다. 현재 산출물을 사내 운영 배포 승인본으로 취급하지 마세요.
